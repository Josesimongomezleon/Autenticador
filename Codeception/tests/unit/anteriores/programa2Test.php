...
class programa2Test extends \Codeception\Test\Unit
{
    /**
     * @var \UnitTester
     */
    ...
    public function Numeros(){
        ...
        $evaludora="5+2*3";
        $evaludoraParo=$evaludora."$";
        $posfija=infTopos($evaludoraParo);


        $this->assertEquals(1,validar($evaludora));
        $this->assertEquals("523*+$",acadena($posfija));
        $this->assertEquals("11",evaluarPos("523*+$"));
        $this->assertEquals(true,comparar($evaludora,"11"));
